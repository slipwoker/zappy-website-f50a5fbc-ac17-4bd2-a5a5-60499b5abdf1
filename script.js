    ...
    if ('IntersectionObserver' in window) {
      ...
      function checkScrollAnimations() {
        ...
        animatedElements.forEach(function (el) {
          ...
          const triggerPoint = scrollTop + windowHeight - 60;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f50a5fbc-ac17-4bd2-a5a5-60499b5abdf1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f50a5fbc-ac17-4bd2-a5a5-60499b5abdf1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f50a5fbc-ac17-4bd2-a5a5-60499b5abdf1';
